...
class CostPanel extends JPanel {
	...
	CostPanel() {
		...
		nodeInsertionCostField = initTextField("Node insertion", 0.38D);
		
		constraints.gridx++;
		
		edgeInsertionCostField = initTextField("Edge insertion", 0.15D);
		
		constraints.gridx = 0;
		constraints.gridy++;
		
		nodeDeletionCostField = initTextField("Node deletion", 0.92D);
		
		constraints.gridx++;
		
		edgeDeletionCostField = initTextField("Edge deletion", 0.85D);
		
		constraints.gridx = 0;
		constraints.gridy++;
		
		nodeSubstitutionCostField = initTextField("Node substitution", 1000000D);
