...
public class DijkstraPT {
	...
	// assumes Nodes are numbered 0, 1, ... n and that the source Node is 0
	   ...
	   public static void main(String args[])  {
		   ...
		   /*path from 10 to 12 through 8: 10 8 9 4 12 
		   path from 10 to 12 through 3: 10 3 17 4 12 
		   path from 10 to 12 through 5: 10 3 5 10 3 17 4 12 
		   path from 10 to 12 through 9: 10 8 9 4 12 
		   path from 10 to 12 through 17: 10 3 17 4 12 
		   path from 10 to 12 through 4: 10 3 17 4 12 
		   path from 10 to 12 through 14: 10 3 17 4 14 4 12 
		   */
		   
		   edges[0] = new Edge(nodes[0],nodes[1],1);   
		   edges[1] = new Edge(nodes[0],nodes[2],1);   
		   edges[2] = new Edge(nodes[2],nodes[2],1);   
		   edges[3] = new Edge(nodes[2],nodes[3],1);   
		   edges[4] = new Edge(nodes[3],nodes[0],1);   
		   edges[5] = new Edge(nodes[2],nodes[5],1);   
		   edges[6] = new Edge(nodes[1],nodes[4],1);   
		   edges[7] = new Edge(nodes[4],nodes[4],1);   
		   edges[8] = new Edge(nodes[5],nodes[6],1);   
		   edges[9] = new Edge(nodes[4],nodes[6],1);   
		   edges[10] = new Edge(nodes[6],nodes[7],1);   
		   edges[11] = new Edge(nodes[6],nodes[8],1);   
		   edges[12] = new Edge(nodes[7],nodes[6],1);   
		   edges[13] = new Edge(nodes[7],nodes[2],1);
		   
		   /*path from 10 to 12 through 8: 10 8 9 4 12 
		   path from 10 to 12 through 3: 10 3 17 4 12 
		   path from 10 to 12 through 5: 10 3 5 10 8 9 4 12 
		   path from 10 to 12 through 9: 10 8 9 4 12 
		   path from 10 to 12 through 17: 10 3 17 4 12 
		   path from 10 to 12 through 4: 10 8 9 4 12 
		   path from 10 to 12 through 14: 10 8 9 4 14 4 12 */
		  
		   source = nodes[0];
		   target = nodes[8];
		   
		   DijkstraPT dijkstra = new DijkstraPT();
		   ...
		   for(Node i: nodes){
			   if(i.getName()!=source.getName() && i.getName()!=target.getName()){
				   ...
				   System.out.print("path from "+source.getName()+" to "+target.getName()+" through "+i.getName()+": ");
				   for (Node k:path){
