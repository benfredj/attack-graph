...
public final class Fraction extends Number implements Comparable<Fraction> {
     ...
     */
    private transient long hashCode = 0;
    /**
     ...
     */
    public static Fraction getFraction(long whole, long numerator, long denominator) {
        if (denominator == 0) {
            throw new ArithmeticException("The denominator must not be zero");
        }
        if (denominator < 0) {
...
//            System.out.println(">>" + delta1 +" "+ delta2+" "+(delta1 > delta2)+" "+i+" "+denom2);
    ...
    private Fraction addSub(Fraction fraction, boolean isAdd) {
        ...
        long tmodd1 = t.mod(BigInteger.valueOf(d1)).intValue();
