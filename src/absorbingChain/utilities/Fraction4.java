 ...
 */
public final class Fraction4 extends Number implements Comparable<Fraction4> {
     ...
     */
    public static final Fraction4 ZERO = new Fraction4(0, 1);
    /**
     * <code>Fraction</code> representation of 1.
     */
    public static final Fraction4 ONE = new Fraction4(1, 1);
    /**
     * <code>Fraction</code> representation of 1/2.
     */
    public static final Fraction4 ONE_HALF = new Fraction4(1, 2);
    /**
     * <code>Fraction</code> representation of 1/3.
     */
    public static final Fraction4 ONE_THIRD = new Fraction4(1, 3);
    /**
     * <code>Fraction</code> representation of 2/3.
     */
    public static final Fraction4 TWO_THIRDS = new Fraction4(2, 3);
    /**
     * <code>Fraction</code> representation of 1/4.
     */
    public static final Fraction4 ONE_QUARTER = new Fraction4(1, 4);
    /**
     * <code>Fraction</code> representation of 2/4.
     */
    public static final Fraction4 TWO_QUARTERS = new Fraction4(2, 4);
    /**
     * <code>Fraction</code> representation of 3/4.
     */
    public static final Fraction4 THREE_QUARTERS = new Fraction4(3, 4);
    /**
     * <code>Fraction</code> representation of 1/5.
     */
    public static final Fraction4 ONE_FIFTH = new Fraction4(1, 5);
    /**
     * <code>Fraction</code> representation of 2/5.
     */
    public static final Fraction4 TWO_FIFTHS = new Fraction4(2, 5);
    /**
     * <code>Fraction</code> representation of 3/5.
     */
    public static final Fraction4 THREE_FIFTHS = new Fraction4(3, 5);
    /**
     * <code>Fraction</code> representation of 4/5.
     */
    public static final Fraction4 FOUR_FIFTHS = new Fraction4(4, 5);
    ...
    public Fraction4(int numerator) {
        super();
        this.numerator = numerator;
        this.denominator = 1;
    }
     ...
     */
    public static Fraction4 getFraction(int numerator, int denominator) {
        if (denominator == 0) {
        ...
        return new Fraction4(numerator, denominator);
    }
     ...
     */
    public static Fraction4 getFraction(int whole, int numerator, int denominator) {
        if (denominator == 0) {
            throw new ArithmeticException("The denominator must not be zero");
        }
        if (denominator < 0) {
        ...
        return new Fraction4((int) numeratorValue, denominator);
    }
     ...
     * @throws ArithmeticException if the denominator is <code>zero</code>
     */
    public static Fraction4 getReducedFraction(int numerator, int denominator) {
        if (denominator == 0) {
            throw new ArithmeticException("The denominator must not be zero");
        }
        if (numerator==0) {
     ...
     */
    public static Fraction4 getFraction(double value) {
...
//            System.out.println(">>" + delta1 +" "+ delta2+" "+(delta1 > delta2)+" "+i+" "+denom2);
     ...
     */
    public static Fraction4 getFraction(String str) {
        if (str == null) {
    ...
    public Fraction4 reduce() {
        ...
        return Fraction4.getFraction(numerator / gcd, denominator / gcd);
    }
    ...
    public Fraction4 invert() {
        ...
        if (numerator<0) {
            return new Fraction4(-denominator, -numerator);
        } else {
            return new Fraction4(denominator, numerator);
        }
    }
     ...
     *  <code>Integer.MAX_VALUE</code>
     */
    public Fraction4 pow(int power) {
        if (power == 1) {
            return this;
        } else if (power == 0) {
            return ONE;
            ...
            Fraction4 f = this.multiplyBy(this);
     ...
     *  <code>Integer.MAX_VALUE</code>
     */
    public Fraction4 add(Fraction4 fraction) {
     ...
     */
    public Fraction4 subtract(Fraction4 fraction) {
     ...
     *   cannot be represented in an <code>int</code>.
     */
    private Fraction4 addSub(Fraction4 fraction, boolean isAdd) {
        if (fraction == null) {
     ...
     *  <code>Integer.MAX_VALUE</code>
     */
    public Fraction4 multiplyBy(Fraction4 fraction) {
        if (fraction == null) {
            throw new IllegalArgumentException("The fraction must not be null");
        }
     ...
     *  <code>Integer.MAX_VALUE</code>
     */
    public Fraction4 divideBy(Fraction4 fraction) {
        if (fraction == null) {
            throw new IllegalArgumentException("The fraction must not be null");
        }
        if (fraction.numerator == 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Fraction4 == false) {
            return false;
        }
        Fraction4 other = (Fraction4) obj;
     ...
     */
    public int compareTo(Fraction4 other) {
        if (this==other) {
            return 0;
        }
