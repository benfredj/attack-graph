...
public Fraction3( int numerator ) {
	   this.numerator = numerator;
	   this.denominator = 1;
	   this.reduce();
	}
...
public boolean equals (Fraction3 fraction){
...
/**********************************************************
 ...
 Returns:        A Fraction representing the sum of two
                 fractions a & b
***********************************************************/
public Fraction3 add(Fraction3 b)
{
   // check preconditions
   ...
   Fraction3 commonA = new Fraction3();
   Fraction3 commonB = new Fraction3();
   commonA = convert(common);
   commonB = b.convert(common);
   // create new fraction to return as sum
   Fraction3 sum = new Fraction3();
   // calculate sum
...
/**********************************************************
 ...
 Returns:        A Fraction representing the differenct of the
                 two fractions a & b
***********************************************************/
public Fraction3 subtract(Fraction3 b)
{
   // check preconditions
   if ((denominator == 0) || (b.denominator == 0))
      throw new IllegalArgumentException("invalid denominator");
...
/**********************************************************
 ...
 Returns:        A Fraction representing the product of the
                 two fractions a & b
***********************************************************/
public Fraction3 multiply(Fraction3 b)
{
   // check preconditions
   if ((denominator == 0) || (b.denominator == 0))
      throw new IllegalArgumentException("invalid denominator");
   // create new fraction to return as product
   Fraction3 product = new Fraction3();
   // calculate product
...
public Fraction3 inverse(Fraction3 b){
   if ((denominator == 0) || (b.numerator == 0))
      throw new IllegalArgumentException("invalid denominator");
   Fraction3 result = new Fraction3();
...
***********************************************************/
private Fraction3 convert(int common)
{
   Fraction3 result = new Fraction3();
